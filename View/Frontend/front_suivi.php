...
include_once(__DIR__ . '/../../Controller/SuivreRegimeController.php'); // Mettez le bon chemin ici

// Instancier le contrôleur
$suiviRegimeController = new SuiviRegimeController();

// Appeler la méthode listSuivis pour récupérer la liste des suivis
$list = $suiviRegimeController->listSuivis();
...
<body>
        ...
        <div class="row gx-0 align-items-center">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-flex flex-wrap">
                    <a href="#" class="text-muted small me-4"><i class="fas fa-map-marker-alt text-primary me-2"></i>Esprit Arena So8ra</a>
        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="blog.html" class="nav-item nav-link active">Suivre mon régime</a>
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">suivi régime </h4>
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="index.html">Accueil</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-primary">votre suivi régime</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
...
<div class="container py-5">
    <h2 class="text-center mb-5">Ajouter votre poids</h2>
    <form action="/projet/View/Frontend/php/ajouter_suivi.php" method="POST">
        <div class="mb-3">
            <label for="poids" class="form-label">Poids (kg) :</label>
            <input type="number" step="0.1" class="form-control" id="poids" name="poids" required>
        </div>
       
        <button type="submit" class="btn btn-primary">Ajouter Poids</button>
    </form>
</div>
<!-- Affichage des suivis -->
<h2 class="text-center mb-5">Suivi régime </h2>
        ...
        <?php foreach ($list as $suivi): ?>
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <p class="card-text"><strong>Poids :</strong> <?php echo htmlspecialchars($suivi['poids']); ?> kg</p>
                        <p class="card-text"><strong>IMC :</strong> <?php echo htmlspecialchars($suivi['imc']); ?></p>
                        <p class="card-text"><strong>Catégorie :</strong> <?php echo htmlspecialchars($suivi['cat']); ?></p>
                        <p class="card-text"><strong>Motivation :</strong> <?php echo htmlspecialchars($suivi['motivation']); ?></p>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
...
<?php else: ?>
    <p class="text-center">Aucun suivi disponible pour le moment.</p>
<?php endif; ?>
            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6 col-xl-2">
                    <div class="footer-item">
                        ...
                        <a href="#regime"><i class="fas fa-angle-right me-2"></i> régime</a>

                        <a href="contact.html"><i class="fas fa-angle-right me-2"></i> Contactez Nous</a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-md-6 text-center text-md-end text-body">
                    ...
                    Cree par <a class="border-bottom text-white" href="#"> Web Coders</a> Partager par  <a class="border-bottom text-white" href="#">Web Coders</a>
                </div>
            </div>
        </div>
    </div>
