...
include_once(__DIR__ . '/../../Controller/RegimeController.php'); // Mettez le bon chemin ici

// Instancier le contrôleur
$RegimeController = new RegimeController();

// Appeler la méthode listSuivis pour récupérer la liste des suivis
$list = $RegimeController->listRegimes();
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="blog.html" class="nav-item nav-link active">Consulter mon régime</a>
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Régime adapté</h4>
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="index.html">Accueil</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-primary">votre régime</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
...
<h2 class="text-center mb-5">Votre Régime Personnalisé</h2>

<?php if (!empty($list)): ?>
    <div class="row justify-content-center">
        <?php foreach ($list as $regime): ?>
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card regime-card shadow">
                    <div class="card-header text-white bg-primary">
                        <h5 class="card-title mb-0">
                            <?php echo htmlspecialchars($regime['titre']); ?>
                        </h5>
                    </div>
                    <div class="card-body">
                        <p class="card-text">
                            <i class="fas fa-info-circle"></i>
                            <strong>Description :</strong> <?php echo htmlspecialchars($regime['discription']); ?>
                        </p>
                        <p class="card-text">
                            <i class="fas fa-fire"></i>
                            <strong>Calories :</strong> <?php echo htmlspecialchars($regime['kcl']); ?> kcal
                        </p>
                    </div>
