...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <br>
            <br>
            <h2>mettre ajour ton profile</h2>
            <br>
            <br>
            <form method="POST" action="">
                <table class="table">
                    <tr>
                        <th>Nom</th>
                        <td><input class="form-control border-0" type="text" name="nom" value="<?php echo htmlspecialchars($nom); ?>" required></td>
                    </tr>
                    <tr>
                        <th>Prénom</th>
                        <td><input class="form-control border-0" type="text" name="pre" value="<?php echo htmlspecialchars($pre); ?>" required></td>
                    </tr>
                    <tr>
                        <th>Email</th>
                        <td><input class="form-control border-0" type="email" name="email" value="<?php echo htmlspecialchars($email); ?>" required></td>
                    </tr>
                    <tr>
                        <th>Téléphone</th>
                        <td><input class="form-control border-0" type="tel" name="tel" value="<?php echo htmlspecialchars($tel); ?>" required></td>
                    </tr>
                    <tr>
                        <th>Âge</th>
                        <td><input class="form-control border-0" type="number" name="age" value="<?php echo htmlspecialchars($age); ?>" required></td>
                    </tr>
                    <tr>
                        <th>Genre</th>
                        <td>
                    ...
                    <tr>
                        <th>Mot de passe</th>
                        <td><input class="form-control border-0" type="password" name="pwd" value="<?php echo htmlspecialchars($pwd); ?>" required></td>
                    </tr>
                    <tr>
                        <td colspan="2">
