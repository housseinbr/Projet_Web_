        ...
        <body>
            ...
            <body>
                <div class="container my-5">
                    <h1 class="text-center mb-4" style="color: #3CB371;">Formulaire de Réservation</h1>
                    <div class="form-container">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="email_nutritioniste" class="form-label">Email Nutritionniste :</label>
                                <input type="email" class="form-control" id="email_nutritioniste" name="email_nutritioniste" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="heure_reservation" class="form-label">Heure de Réservation :</label>
                                <input type="time" class="form-control" id="heure_reservation" name="heure_reservation" required>
                            </div>
                            <div class="mb-3">
                                <label for="image_client" class="form-label">Photo du Client :</label>
                                <input type="file" class="form-control" id="image_client" name="image" accept="image/*"> <!-- Make sure this is 'image' -->
                            </div>
