...
$listCat = $accessController->listCategories();
?>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="ajoutercat.php">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php foreach ($listCat as $category): ?>
                                                <tr>
                                                    <td><?php echo htmlspecialchars($category['id_cat'], ENT_QUOTES); ?></td>
                                                    <td class="text-truncate"><?php echo htmlspecialchars($category['categorie'], ENT_QUOTES); ?></td>
                                                    <td>
                                                        <a href="modifiercat.php?id_cat=<?php echo htmlspecialchars($category['id_cat'], ENT_QUOTES); ?>" class="btn btn-primary">Update</a>
                                                        <a href="supprimercat.php?id_cat=<?php echo htmlspecialchars($category['id_cat'], ENT_QUOTES); ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?')">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
