    ...
    <div class="container-fluid topbar bg-light px-5 d-none d-lg-block">
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Merci pour votre commande ! </h4>
            </div>
        </div>
        <!-- Header End -->
    </div>
    ...
    <div class="container-fluid blog py-5">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                <h1 class="display-5 mb-4">Commande Confirmer</h1>
                <p class="mb-0">Votre commande a bien etait confirmer merci pour votre confiance !</p>
                <a class="btn btn-primary mt-5" href="boutique.php">Retour</a>
            </div>
        </div>
    </div>
    <!-- Blog End -->
