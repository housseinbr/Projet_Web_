...
$listeProduits = $produitController->listProduit();
?>
    ...
    <div class="container-fluid topbar bg-light px-5 d-none d-lg-block">
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Notre Boutique</h4>
                <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                    <li class="breadcrumb-item"><a href="index.html">Accueil</a></li>
                    <li class="breadcrumb-item"><a href="#">Pages</a></li>
                    <li class="breadcrumb-item active text-primary">Notre Boutique</li>
                </ol>
            </div>
        </div>
        <!-- Header End -->
    ...
    <div class="container-fluid blog py-5">
        <div class="container py-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                <h4 class="text-primary">Notre boutique</h4>
                <h1 class="display-5 mb-4">Terre & Forme</h1>
                <p class="mb-0">Bienvenue chez Terre & Forme, Notre boutique en ligne spécialisée dans les produits
                    agricoles et de sports. Nous réunissons deux passions : le respect de la terre et le bien-être
                    physique, en proposant des produits de qualité pour cultiver, nourrir et se dépasser.
                </p>
            </div>
            ...
            foreach ($listeProduits as $produit) { 
                // Assuming each product has 'image', 'nom', 'description', 'categorie', 'prix', and 'dispo' fields
            ?>
                <div class="col-lg-3 col-md-4 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card border-0 shadow-sm rounded">
                        <img src="../../images/<?php echo htmlspecialchars($produit['image'], ENT_QUOTES); ?>"
                            alt="Product Image" class="card-img-top" style="width: 100%; height: auto;">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo htmlspecialchars($produit['nom'], ENT_QUOTES); ?></h5>
                            <p class="card-text"><?php echo htmlspecialchars($produit['description'], ENT_QUOTES); ?>
                            </p>
                            <p class="text-muted">Catégorie:
                                <?php echo htmlspecialchars($produit['categorie'], ENT_QUOTES); ?></p>
                            <p class="text-primary"><?php echo htmlspecialchars($produit['prix'], ENT_QUOTES); ?> $</p>

                            <!-- Availability status -->
                            <?php if ($produit['dispo'] == "Disponible") { ?>
                            <span class="badge bg-success">Disponible</span>
                            <?php } else { ?>
                            <span class="badge bg-danger">Hors Stock</span>
                            <?php } ?>
                        </div>
                        <a class="btn btn-info mb-2" href="panier.php?id=<?php echo $produit['idProduit']; ?> ">Add
                            To cart</a>
            ...
            <div class="row g-5">
                <div class="col-md-6 col-lg-6 col-xl-4">
                    <div class="footer-item">
                        ...
                        <p class="mb-4">Bienvenue chez Terre & Forme, Notre boutique en ligne spécialisée dans les
                            produits agricoles et de sports. Nous réunissons deux passions : le respect de la terre et
                            le bien-être physique, en proposant des produits de qualité pour cultiver, nourrir et se
                            dépasser.</p>
                        <div class="d-flex">
            ...
            <div class="row g-4 align-items-center">
                <div class="col-md-6 text-center text-md-start mb-md-0">
                    <span class="text-body"><a href="#" class="border-bottom text-white"><i
                                class="fas fa-copyright text-light me-2"></i>HYGEIA</a>, Tous droits réservés.</span>
                </div>
                <div class="col-md-6 text-center text-md-end text-body">
                    <!--/*** This template is free as long as you keep the below author’s credit link/attribution link/backlink. ***/-->
                    <!--/*** If you'd like to use the template without the below author’s credit link/attribution link/backlink, ***/-->
                    <!--/*** you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". ***/-->
                    Cree par <a class="border-bottom text-white" href="https://htmlcodex.com"> Web Coders</a> Partager
