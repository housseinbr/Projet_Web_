...
<body>
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nom" name="nom"
                                                placeholder="Enter le Nom de la categorie">
                                            <span id="erreurcat" class="text-danger"></span>
                                        </div>
                                        <div class="form-group">
    ...
    function validateForm() {
        ...
        if (!nom || nom.length < 5) {
            document.getElementById('erreurcat').innerText = "Nom invalide (au moins 2 caractères).";
            isValid = false;
        }
