...
if (
    ...
    if (
        ...
        if (isset($_FILES["image"]) && !empty($_FILES['image']['name'])) {
            ...
            $imageName = $Produit['image']; // Keep the old image name
        }

        // Create the updated product object with the (possibly unchanged) image name
        $Produit = new Produit(
            $_POST['idProduit'],
            $_POST['nom'],
            $_POST['description'],
            ...
            $_POST['prix'],
            $_POST['dispo'],
            $imageName // Store the image file name (either new or old)
        );
...
<body>
                                ...
                                <form action="" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="idProduit" name="idProduit"
                                                value="<?php echo $_POST['idProduit'] ?>" readonly />
                                        </div>

                                        <div class="form-group">
                                            <label for="nom">Nom Produit</label>
                                            <input type="text" class="form-control" id="nom" name="nom"
                                                value="<?php echo $Produit['nom'] ?>" placeholder="Enter Nom Produit" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="description" name="description"
                                                value="<?php echo $Produit['description'] ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="categorie" name="categorie">
                                                ...
                                                <option value="<?= $categorie['id'] ?>">
                                                    <?= htmlspecialchars($categorie['categorie']) ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="prix" name="prix"
                                                value="<?php echo $Produit['prix'] ?>" placeholder="Enter le prix" />
                                            <span id="erreurPrix" class="text-danger"></span>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="dispo" name="dispo">
                                                <option value="Disponible"
                                                    <?php echo $Produit['dispo'] == 'Disponible' ? 'selected' : ''; ?>>
                                                    Disponible</option>
                                                <option value="Hors stock"
                                                    <?php echo $Produit['dispo'] == 'Hors stock' ? 'selected' : ''; ?>>
                                                    Hors
                                                    stock</option>
                                            </select>
                                            <span id="erreurDispo" class="text-danger"></span>
                                        </div>

                                        <div class="form-group">
                                            <label for="image">Image</label>
                                            <input type="file" class="form-control" id="image" name="image" />
                                            <p>Current image: <?php echo $Produit['image']; ?></p>
                                            <span id="erreurImage" class="text-danger"></span>
                                        </div>
                                    </div>
    ...
    function validateForm() {
        ...
        if (!nom || nom.length < 2) {
            document.getElementById('erreurNom').innerText = "Nom invalide (au moins 2 caractères).";
            isValid = false;
        }
        ...
        if (!prix || isNaN(prix) || parseFloat(prix) <= 0) {
            document.getElementById('erreurPrix').innerText = "Prix invalide.";
            isValid = false;
        }
