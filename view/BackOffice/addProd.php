...
if (
    isset($_POST["nom"], $_POST["description"], $_POST["categorie"], $_POST["prix"], $_POST["dispo"], $_FILES["image"]) &&
    !empty($_POST['nom']) &&
    ...
    // Define the image upload directory (relative to the current script)
    $targetDirectory = '../../images/';

    // Get the image file's original name
    $imageName = basename($_FILES["image"]["name"]);

    // Define the target file path (including the directory)
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)) {
        ...
        $Produit = new Produit(
            ...
            $_POST['prix'],
            $_POST['dispo'],
            $imageName // Store only the filename in the database
        );
...
<body>
    ...
    function validateForm() {
        ...
        if (!image) {
            document.getElementById('erreurImage').innerText = "Veuillez choisir une image.";
            isValid = false;
        }
