...
$listecategories = $CategorieController->listCategorie();
?>
...
foreach ($listecategories as $categorie) {
    echo "<tr>";
    echo "<td>" . htmlspecialchars($categorie['categorie'], ENT_QUOTES) . "</td>";
    echo "<td>" . htmlspecialchars($categorie['description'], ENT_QUOTES) . "</td>";

    echo "<td>
            <form method='POST' action='editCat.php' style='display:inline;'>
                <input type='submit' name='update' value='Update' class='btn btn-primary'>
                <input type='hidden' value='" . htmlspecialchars($categorie['id'], ENT_QUOTES) . "' name='id'>
            </form>
            <a href='deleteCat.php?id=" . htmlspecialchars($categorie['id'], ENT_QUOTES) . "' class='btn btn-danger' onclick='return confirm(\"Are you sure you want to delete this Categorie ?\")'>Delete</a>
          </td>";    
    echo '</tr>';   
}
?>
