...
class utilisateur_controller {
    ...
    <!-- Table for managing users (first instance) -->
    <div class="row">
                                ...
                                <?php if (isset($users) && is_array($users)): ?>
                                    <?php foreach ($users as $user): ?>
                                        <tr id="user-<?php echo $user['id_u']; ?>">
                                            <td><?php echo htmlspecialchars($user['id_u']); ?></td>
                                            <td><?php echo htmlspecialchars($user['nom']); ?></td>
                                            <td><?php echo htmlspecialchars($user['pre']); ?></td>
                                            <td><?php echo htmlspecialchars($user['email']); ?></td>
                                            <td><?php echo htmlspecialchars($user['tel']); ?></td>
                                            <td><?php echo htmlspecialchars($user['age']); ?></td>
                                            <td class="badge <?php echo ($user['genre'] == 1) ? 'badge-outline-success' : 'badge-outline-danger'; ?>">
